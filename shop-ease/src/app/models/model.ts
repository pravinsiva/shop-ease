...
export const produts: Array<IProducts> = [
  ...
  },
  {
    ...
    offer: 0.1,
    prodDesc:
      'Dell Latitude 5420 Intel i5 1135G7 14 inches FHD Business Laptop (8GB, 512GB NVMe, Windows 10 Pro, 3 Year ADP, 1.37Kg)',
    categoryID: 1,
    displayedImage: '',
  },
  {
    ...
    offer: 0.1,
    prodDesc:
      'AirPods Pro, MagSafe Charging Case with speaker and lanyard loop, Silicone ear tips (four sizes: XS, S, M, L).',
    categoryID: 1,
    displayedImage: '',
  },
  {
  ...
  },
  {
    ...
    offer: 0.2,
    prodDesc:
      'Expansion 2TB External HDD - USB 3.0 for Windows and Mac with 3 yr Data Recovery Services, Portable Hard Drive (STKM2000400)',
    categoryID: 1,
    displayedImage: '',
  },
];
...
export const sorting: ISorting[] = [
  { key: 'asc', val: 'Ascending' },
  { key: 'desc', val: 'Descending' },
];
